...
from master_forms.models import AcademicSession, Modules, Screen, UserType, UserRole, YearofAdmission, UserOperations, \
    Nationality, State, City, District, Tehsil, PostalCode, MotherTongue, Religion, Gender, BloodGroup, Course, \
    Semesters, Sections, TwelvethOrDiploma, StreamOrField, Subjects, Days, Time, Lecture, Category, Reserved, \
    ApplyingConcession, Cast, SubCast, Degree, DegreeStreamOrField, PhysicallyChallenged
...
class ScreenAdmin(admin.ModelAdmin):
    list_display = ('id', 'fk_modules', 'screen_name')
...
class UserOperationsAdmin(admin.ModelAdmin):
    list_display = ('id', 'fk_screen', 'fk_modules', 'fk_user_role', 'status')


admin.site.register(UserOperations, UserOperationsAdmin)
