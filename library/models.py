...
class BooksPurchase(models.Model):
    ...
    """
    fk_user_info = models.ForeignKey(UserInfo, blank=True, null=True, on_delete=models.PROTECT)
...
class BooksIssue(models.Model):
    ...
    fk_course = models.ForeignKey(Course, blank=True, null=True, on_delete=models.PROTECT)
    fk_semester = models.ForeignKey(Semester, blank=True, null=True, on_delete=models.PROTECT)
    fk_section = models.ForeignKey(Section, blank=True, null=True, on_delete=models.PROTECT)
...
class BooksIssueData(models.Model):
    ...
    """
    fk_user_info = models.ForeignKey(UserInfo, blank=True, null=True, on_delete=models.PROTECT)
    fk_book_purchase = models.ForeignKey(BooksPurchase, blank=True, null=True, on_delete=models.PROTECT)
...
class BooksReturned(models.Model):
    ...
    """
    fk_user_info = models.ForeignKey(UserInfo, blank=True, null=True, on_delete=models.PROTECT)
    fk_books_issue_data = models.ForeignKey(BooksIssueData, blank=True, null=True, on_delete=models.PROTECT)
