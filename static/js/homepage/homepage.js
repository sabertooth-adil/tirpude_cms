...
$("#inputforgetpassword").keyup(function () {
...
function forget_password() {
    var emailfilter = /^\b[A-Z0-9._%-]+@[A-Z0-9.-]+\.[A-Z]{2,4}\b$/i
    var inputforgetpassword = $("#inputforgetpassword").val();
    if (inputforgetpassword == "") {
        $("#err_forgetpassword_email").show();
    } else if (!emailfilter.test(inputforgetpassword)) {
