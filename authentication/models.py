...
from master_forms.models import UserType, UserRole, Gender, MotherTongue, Nationality, Religion, BloodGroup, City, \
    State, District, Course, Semesters, Sections, YearofAdmission, TwelvethOrDiploma, StreamOrField, \
    DegreeStreamOrField, Degree, Category, Reserved, ApplyingConcession, Cast, SubCast, PhysicallyChallenged, \
    AcademicSession
...
class AddressDetail(models.Model):
    ...
    fk_district = models.ForeignKey(District, blank=True, null=True, on_delete=models.CASCADE,related_name='fk_district')
    ...
    fk_correspondence_city = models.ForeignKey(City, blank=True, null=True, on_delete=models.CASCADE,related_name='fk_correspondence_city')
    fk_correspondence_state = models.ForeignKey(State, blank=True, null=True, on_delete=models.CASCADE,related_name='fk_correspondence_state')
    fk_correspondence_district = models.ForeignKey(District, blank=True, null=True, on_delete=models.CASCADE,related_name='fk_correspondence_district')
...
class AcademicInfo(models.Model):
    ...
    fk_sections = models.ForeignKey(Sections, blank=True, null=True, on_delete=models.CASCADE)
